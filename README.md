...
公開リポジトリのGitHub Actionsから5分間隔で監視を起動し、ドラチケへログイン後、「一般チケット」→「一般席」まで進みます。在庫が「なし→あり」または「あり→なし」に変化した場合だけLINE公式アカウントから通知します。カレンダーの「発売中」表示だけでは通知せず、定期的な状態通知も行いません。購入操作そのものは行いません。
