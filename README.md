...
GitHubの `Actions` → `ドラチケ監視（9/12 ヤクルト・9/21 広島）` → `Run workflow` を実行します。成功後はGitHub Actionsが通常5分間隔、毎日9:50～10:30（日本時間）は2分間隔で2試合をまとめて確認します。GitHub側の都合で開始が数分以上遅れる場合があります。
